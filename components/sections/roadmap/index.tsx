        ...
        <div className="relative grid gap-6 md:grid-cols-2 md:gap-4 md:pb-28">
          {roadmap.map((item) => {
            ...
            return (
              ...
              >
                {/* Fixed White Background: Changed bg-n-1 to bg-n-8 */}
                <div className="relative flex flex-col justify-between w-full overflow-hidden rounded-[2.4375rem] bg-n-8/90 backdrop-blur-xl p-8 xl:p-15 transition-colors group-hover:bg-n-8/70">
                  ...
                  <div className="relative z-1 flex-grow flex flex-col">
                    <div className="mb-12 flex items-center justify-between">
                      ...
                      {/* Fixed Status Pill: Changed bg-n-2 to bg-n-7 */}
                      <div className="flex items-center rounded bg-n-7 border border-n-6 px-4 py-1 text-white shadow-[0_0_10px_rgba(255,255,255,0.02)]">
                        <div className={cn(
                    ...
                    <h4 className="font-orbitron text-3xl mb-4 text-white group-hover:text-transparent group-hover:bg-clip-text group-hover:bg-gradient-to-r group-hover:from-color-4 group-hover:to-color-5 transition-all duration-300">
                      {item.title}
                    </h4>
